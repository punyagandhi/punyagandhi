...
![Skills](https://skillicons.dev/icons?i=react,html,css,python,arduino,discord,vscode,github,cloudflare,supabase,vercel,firebase,canva,latex,jupyter,anaconda,pycharm,photoshop,twitter,linkedin,notion,instagram,twitch,github,youtube,orcid)
