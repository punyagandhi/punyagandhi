...
![Skills](https://skillicons.dev/icons?i=react,html,css,python,java,ts,js,figma,arduino,discord,js,vscode,github,cloudflare,supabase,convex,freebuff,cpp,firebase,canva,go,php,ruby)
